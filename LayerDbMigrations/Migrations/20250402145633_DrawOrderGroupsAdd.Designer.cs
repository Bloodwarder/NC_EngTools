...
namespace LayerDbMigrations.Migrations
{
    ...
    [Migration("20250402145633_DrawOrderGroupsAdd")]
    partial class DrawOrderGroupsAdd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LayersIO.Model.DrawOrderGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LayersIO.Model.LayerData", b =>
                {
                    ...
                    b.Property<int?>("DrawOrderGroupId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LayersIO.Model.LayerData", b =>
                {
                    b.HasOne("LayersIO.Model.DrawOrderGroup", "DrawOrderGroup")
                        .WithMany("Layers")
                        .HasForeignKey("DrawOrderGroupId")
