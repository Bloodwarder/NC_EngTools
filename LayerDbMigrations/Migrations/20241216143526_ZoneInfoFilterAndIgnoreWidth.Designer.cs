...
namespace LayerDbMigrations.Migrations
{
    ...
    [Migration("20241216143526_ZoneInfoFilterAndIgnoreWidth")]
    partial class ZoneInfoFilterAndIgnoreWidth
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LayersIO.Model.LayerData", b =>
                {
                    ...
                    b.HasIndex("Prefix", "MainName", "StatusName")
                        .IsUnique();
            ...
            modelBuilder.Entity("LayersIO.Model.ZoneInfoData", b =>
                {
                    ...
                    b.HasIndex("SourceLayerId", "ZoneLayerId")
                        .IsUnique();
